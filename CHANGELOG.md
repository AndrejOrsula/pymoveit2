...
- Add example for `RobotSession` usage via `connect()` ([f055649](https://github.com/AndrejOrsula/pymoveit2/commit/f0556496b13778d3fa4d16784c218e337efec548))
- CI: Add PyPI release workflow for Python package distribution ([f8a59d8](https://github.com/AndrejOrsula/pymoveit2/commit/f8a59d8d3afc5c1a8152681849f4e155a1133a20))
- CI: Add Docker release workflow ([f39838f](https://github.com/AndrejOrsula/pymoveit2/commit/f39838fcfc03e4c358a231c582bcce173adcb59e))
- Add doctor example to help with diagnosing MoveIt 2 setup issues ([3911a84](https://github.com/AndrejOrsula/pymoveit2/commit/3911a846dea44898f15516d05c0d2b27421dad99))
- Docker: Add Dockerfile and helper scripts ([9d32e1c](https://github.com/AndrejOrsula/pymoveit2/commit/9d32e1c2c65e6c591111e9bd1ed139c8148bad77))
- Add simplified RobotSession manager for MoveIt2 interfaces ([41754d7](https://github.com/AndrejOrsula/pymoveit2/commit/41754d707a651984fb725e11c78c900ea943505b))
- Add script for running tests across different ROS 2 distributions ([53ae617](https://github.com/AndrejOrsula/pymoveit2/commit/53ae6178e4fcb3f8205bc187170af3d386656fc1))
- Add integration tests ([57b3886](https://github.com/AndrejOrsula/pymoveit2/commit/57b388697b482807c9c4d972ce4666fea0d3e4c2))
- Add typecheck test ([3d0060e](https://github.com/AndrejOrsula/pymoveit2/commit/3d0060ef7f5606177d0730cbe5336cd8a6d6fd04))
- Add core tests ([31d37b8](https://github.com/AndrejOrsula/pymoveit2/commit/31d37b8f40a96e1894a885ee97d07369871bedbf))
- Add Python package manifest and metadata ([de8842c](https://github.com/AndrejOrsula/pymoveit2/commit/de8842c68aee86f93b299a8680c926e0764eb04d))
- Add automated robot description discovery ([5c941c4](https://github.com/AndrejOrsula/pymoveit2/commit/5c941c4579f2acbf672d6ec0963415befa34afec))
- Gitignore: Add cache and coverage reports ([f82f918](https://github.com/AndrejOrsula/pymoveit2/commit/f82f91854bfd8d83397a22ebf3120aa26c21db71))
...
- Update CHANGELOG for 5.0.0 ([f9f95eb](https://github.com/AndrejOrsula/pymoveit2/commit/f9f95ebfbb615f2979dd144dd1a28b3f6c3eefc9))
- Deprecate `max_step` parameter in favor of `cartesian_max_step` ([d101370](https://github.com/AndrejOrsula/pymoveit2/commit/d101370190295738528c1efb3f66b710d7afcdf0))
- Update documentation for the 5.0.0 release ([d83a4c3](https://github.com/AndrejOrsula/pymoveit2/commit/d83a4c3487b88c9222fcc2702a124cefa42843a4))
- CI: Update Debian package build workflow ([69c4801](https://github.com/AndrejOrsula/pymoveit2/commit/69c480123d7304690e22ae4c5afbaf91dd0e207f))
- CI: Update Dependabot automation ([99581a9](https://github.com/AndrejOrsula/pymoveit2/commit/99581a98e2e97ef37dd69bfe52eeac812b24d8b3))
- CI: Automate testing and codecov reporting across ROS 2 distributions ([fb66745](https://github.com/AndrejOrsula/pymoveit2/commit/fb6674577d1d102dbd71ad66c6741f541257ed79))
- CI: Update pre-commit workflow ([cbf470f](https://github.com/AndrejOrsula/pymoveit2/commit/cbf470f98bac7c35d41bda402515af2888ce5c47))
- Update examples ([0371a5d](https://github.com/AndrejOrsula/pymoveit2/commit/0371a5d81677ccd35aafc6921113b393d4930f91))
- Update ROS 2 package manifest ([7b2824b](https://github.com/AndrejOrsula/pymoveit2/commit/7b2824b9a361a4b6d6a24c934f1d844e7485aa21))
- Standardize MoveIt2Servo across different ROS 2 distributions ([b055206](https://github.com/AndrejOrsula/pymoveit2/commit/b055206a56ea70e447805884ee82fd236e08f2ac))
- Refactor the unified gripper interface with lifecycle management and joint state validation ([6654cd6](https://github.com/AndrejOrsula/pymoveit2/commit/6654cd696d5c1585eabc5cb0c51d9ed42cefac7c))
- Refactor MoveIt2 interface with lifecycle management and error handling ([2643626](https://github.com/AndrejOrsula/pymoveit2/commit/26436266b87ece569c2bdbe89e0d5503a20ce3be))
- License: Update copyright year to 2026 ([0fcccf1](https://github.com/AndrejOrsula/pymoveit2/commit/0fcccf168b63929369da1f5eb71eb80bbc66d581))
- Pre-commit: Update hooks ([c2bbfb4](https://github.com/AndrejOrsula/pymoveit2/commit/c2bbfb45f7cbc23f9008289af0e08c6a627a5165))
- Pre-commit: Update setup script usage message ([3b9d727](https://github.com/AndrejOrsula/pymoveit2/commit/3b9d727af7f6594791411c3b2b398b575904f511))
...
- Fix dockerignore matches across tests ([747ea2a](https://github.com/AndrejOrsula/pymoveit2/commit/747ea2a2f7cfc0bb84eb8f20c20c558213d30ed2))
- CI: Fix path to scripts and set coverage threshold to 65% ([5de2535](https://github.com/AndrejOrsula/pymoveit2/commit/5de253595b7d835a9c4d2a06479ef7dfff55950f))
